                                     ...
                                     <div id="rootwizard">
										...
										<form id="" name="formselct" action="" method="Post">
                                                        <div class="form-group col-md-12">
															...
															<select  class="form-control" id="" name="" onchange="checkValue(this)">
															...
															<select  class="form-control" id="name" name="select1" onchange="checkValue(this)">
																...
																<div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="file" class="form-control date-picker" id="date" name="" placeholder="Upload File" required="">
                                                                </div>
