                    ...
                    <form id="" name="formselct" action="" method="Post">
                              ...
                              <select  class="form-control" id="name" name="select1" onchange="checkValue(this)">
                                ...
                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control date-picker" id="date" name="" placeholder="Expected Date" required="">
                                                                </div>
                                <div class="form-group col-md-12">
                                                                    <label>End Date</label>
                                                                    <input type="text" class="form-control date-picker" id="date" name="" placeholder="End Date" required="">
                                                                </div>
